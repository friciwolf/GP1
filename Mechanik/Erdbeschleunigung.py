...
errl_stat=0.001
errr_stat=0.0001
errl_sys=0.0002+0.0003*1 # Güteklasse II:a+b*L mit a=0.2mm, b=0.3mm/m, L= auf ganzen Meter gerundete zu messende Länge
T=[]
errT=[]
...
f=1/T
errf=f*errT/T
print('Frequenz: f=({1} +- {2}) Hz'.format(*Rauschmessung.round_good(0,f,errf)))

g=4*np.pi**2*f**2*l*(1+r**2/l**2/2)
errg_stat=(g/l-4*np.pi**2*f**2*r**2/l**2)*errl_stat #TODO: vlt.genauer?
