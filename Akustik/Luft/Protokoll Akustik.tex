...
liegt.
	...
	\subsubsection{Aufbau und Durchführung}
	Im diesem Teil untersucht man die Resonanzfrequenzen einer akkustischen Welle, indem man ihr Profil durch Variieren der Frequenz eines von einem Lautsprecher erzeugten Testklangs mithilfe eines Mikrofons aufnimmt. An der Resonanzstelle springt am Mikrofon abgegriffene Spannung hoch, dessen Maximalstellen mit Gleichung \ref{e3} zur Bestimmung der Schallgeschwindigkeit dienen (Fall konstanter Länge $L$).\\
